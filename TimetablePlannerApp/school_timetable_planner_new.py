...
class TimetableApp:
    def __init__(self, root):
        ...
        self.current_week = datetime.now().isocalendar()[1]  # Store current week number
    ...
    def setup_db(self):
        ...
        self.c.execute('''CREATE TABLE IF NOT EXISTS timetable (
        ...
        # Add year and week columns if they don't exist
        try:
